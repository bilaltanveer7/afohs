...
const orderDetail = {
    ...
    items: [
        ...
        },
        {
            ...
            price: 5.0,
            image:
                "https://images.unsplash.com/photo-1562376552-0d160a2f35b6?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
        },
        {
        ...
        <>
            ...
            <div style={{
                ...
                <div style={styles.root}>
                    <Box p={2}>
                        {/* Tab Navigation */}
                        <Box display="flex" mb={2} overflow="auto" pb={1}>
                            <Button
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} md={5}>
                                {/* Revenue Card */}
                                <Box style={styles.revenueCard} mb={2}>
                                ...
                                {/* Transactions Card */}
                                <Box style={styles.transactionCard} mb={2}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6}>
                                        <Box style={styles.productSoldCard}>
                                            <Box display="flex" alignItems="center" mb={2}>
                                                <Box
                                                    display="flex"
                                                    alignItems="center"
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="h5" fontWeight="bold">
                                                        500 <span style={{ fontSize: "14px", fontWeight: "normal" }}>Items</span>
                                                    </Typography>
                                                </Box>
                                            </Box>
                                        </Box>
                                    ...
                                    <Grid item xs={6}>
                                        <Box style={styles.totalOrderCard}>
                                            <Box display="flex" alignItems="center" mb={2}>
                                                <Box
                                                    display="flex"
                                                    alignItems="center"
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="h5" fontWeight="bold">
                                                        380 <span style={{ fontSize: "14px", fontWeight: "normal" }}>Order</span>
                                                    </Typography>
                                                </Box>
                                            </Box>
                                        </Box>
                    ...
                    >
                        ...
                        <DialogContent>
                            <Box style={styles.orderDetailHeader}>
                                <Box display="flex" alignItems="center" flex={1}>
                                    <Avatar style={{ width: 36, height: 36, marginRight: 8 }}>
                                        <PersonIcon />
                                    </Avatar>
                                    <Box>
                                        <Typography variant="subtitle1" fontWeight="bold">
                                ...
                                <Avatar style={styles.orderDetailAvatar}>{orderDetail.tableNumber}</Avatar>
                            ...
                            <Grid container spacing={2} style={styles.orderInfoGrid}>
                                <Grid item xs={4}>
                                    <Typography variant="body2" style={styles.orderInfoLabel}>
                                        Order Date
                                    </Typography>
                                    <Typography variant="body1" style={styles.orderInfoValue}>
                                        {orderDetail.date}
                                    </Typography>
                                </Grid>
                                <Grid item xs={4}>
                            ...
                            <Box mb={2}>
                                <Chip label={`Order Id : ${orderDetail.id}`} style={styles.orderIdChip} />
                            </Box>

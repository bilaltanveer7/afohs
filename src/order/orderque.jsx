                    ...
                    <div className="container-fluid p-0" style={{ backgroundColor: "#f5f5f5", minHeight: "100vh" }}>
                        ...
                        <div className="p-3" style={{ backgroundColor: "#f5f5f5" }}>
                            <div className="d-flex align-items-center">
                                <IconButton size="small" style={{ color: "#3F4E4F", width: 24, height: 24 }}>
                                    <ArrowBack onClick={() => navigate('/dashboard')} />
                                </IconButton>
                                <Typography variant="h5" className="ms-2" style={{ color: "#3F4E4F", fontSize: '46px', fontWeight: 500 }}>
                                    Order Queue
                                </Typography>
                            </div>
                        ...
                        >
                            <div className="p-3">
                                <div className="d-flex justify-content-between align-items-center">
                                    <div className="d-flex align-items-center">
                                        <Typography variant="h4" style={{ fontSize: "34px", fontWeight: 600, color: "#000000" }}>
                                            9
                                        </Typography>
                                        <Typography variant="body2" className="ms-1 mt-1" style={{ color: "#121212", fontSize: '16px' }}>
                                            Order Queue
                                        </Typography>
                                    </div>
                                        ...
                                        >
                                            <CardContent className="p-3">
                                                ...
                                                <div className="d-flex justify-content-between align-items-start mb-2">
                                                    <div>
                                                        <div className="d-flex align-items-center">
                                                            <Typography variant="subtitle1" style={{ fontSize: "18px", fontWeight: 500, color: '#121212' }}>
                                                                {order.customer}
                                                            </Typography>
                                                            {order.hasVIP && (
                                                                <div
                                                        ...
                                                        <Typography variant="body2" style={{ fontSize: "14px", color: "#7F7F7F" }}>
                                                            {order.totalItems} Items ({order.id === "T2" ? (
                                                                <span style={{ color: "#22D7A6" }}>1 Complete</span>
                                                            ) : order.id === "T3" ? (
                                                                <span style={{ color: "#22D7A6" }}>3 Complete</span>
                                                            ) : order.id === "T4" ? (
                                                                <span style={{ color: "#22D7A6" }}>1 Complete</span>
                                                            ) : null})
                                                        </Typography>

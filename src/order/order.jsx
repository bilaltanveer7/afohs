...
import filtericon from '../assetts/right.png'
import {
  Box,
  Typography,
  Slide,
...
import { ArrowBack, Search, FilterAlt, ContentCopy, ArrowForward, KeyboardArrowUp } from "@mui/icons-material"
...
const AllOrder = () => {
  ...
  const categories = [
    ...
    { id: "beverage", name: "Beverage", icon: coffeeimg },
    { id: "food", name: "Food", icon: capuimg },
    { id: "snack", name: "Snack", icon: bevimg },
    { id: "imaji", name: "Imaji", icon: capuimg },
    { id: "home", name: "Home", icon: coffeeimg },
  ]
      ...
      <div
        ...
        >
          ...
          >
            ...
            >
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <Typography variant="caption" sx={{ fontSize: '12px', color: '#121212', textAlign: 'center' }}>
                    {category.name}
                  </Typography>
                </Box>
              ))}
            ...
            {/* Main Content Area */}
            <Box sx={{ flex: 1, display: "flex", flexDirection: "column", borderRadius: '12px', bgcolor: '#FBFBFB' }}>
              <Paper
                elevation={0}
                sx={{
                  p: 2,
                  ...
                  {products.map((product) => (
                    <Grid item xs={12} sm={6} md={4} lg={3} xl={2} key={product.id}>
                      ...
                      >
                        ...
                        <Typography variant="body1" sx={{ fontWeight: 500, mb: 0.5, textAlign: "center" }}>
                          {product.name}
                        </Typography>
            ...
            >
              ...
              >
                ...
                >
                  Order Saved
                  <Badge badgeContent="3" color="primary" sx={{ ml: 1 }} />
                </Button>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
                <Avatar sx={{ bgcolor: "#1976d2", width: 36, height: 36, mr: 1 }}>T2</Avatar>
                <Box sx={{ mr: "auto" }}>
              ...
              {/* Order Summary */}
              <Paper sx={{ borderRadius: 2, overflow: "hidden", mt: "auto" }}>
                <Box
                  sx={{
                    bgcolor: "#e3f2fd",
                    p: 2,
                ...
                >
                  <Typography variant="subtitle1" sx={{ fontWeight: 500, color: "#0c3b5c" }}>
                    Order Summary
                  </Typography>

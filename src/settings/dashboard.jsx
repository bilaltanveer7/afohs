...
const SettingDashboard = () => {
    ...
    const [bankAccounts, setBankAccounts] = useState([
        { id: 1, name: "Sea Bank", accountNumber: "BB-08543-0892 (Mr. Sahrul)", active: true },
        { id: 2, name: "CIMB Bank", accountNumber: "BB-08543-0892 (Mr. Sahrul)", active: true },
        { id: 3, name: "Citibank", accountNumber: "BB-08543-0892 (Mr. Sahrul)", active: false },
    ])
    ...
    const [printingDevices, setPrintingDevices] = useState([
        { id: 1, name: "Kassen PP-203", location: "Cashier", connected: true, active: true },
        { id: 2, name: "Kassen BT-P290", location: "Cashier", connected: false, active: false },
        { id: 3, name: "Epson TM-T82", location: "Kitchen", connected: true, active: true },
    ])
    ...
    const handleAddCategory = () => {
        if (newCategoryName.trim()) {
            setCategories([...categories, { id: categories.length + 1, name: newCategoryName, active: true }])
            setNewCategoryName("")
            setIsAddingCategory(false)
        }
    }
    ...
    const handlePaymentTypeActiveChange = (id) => {
        setPaymentTypes(
            paymentTypes.map((paymentType) =>
                paymentType.id === id ? { ...paymentType, active: !paymentType.active } : paymentType,
            ),
        )
    }
    ...
    const handleAddPaymentType = () => {
        if (newPaymentType.trim()) {
            setPaymentTypes([...paymentTypes, { id: paymentTypes.length + 1, name: newPaymentType, active: true }])
            setNewPaymentType("")
            setIsAddingPaymentType(false)
        }
    }
    ...
    const handleBankAccountActiveChange = (id) => {
        setBankAccounts(
            bankAccounts.map((bankAccount) =>
                bankAccount.id === id ? { ...bankAccount, active: !bankAccount.active } : bankAccount,
            ),
        )
    }
    ...
    const handlePrintingDeviceActiveChange = (id) => {
        setPrintingDevices(
            printingDevices.map((device) => (device.id === id ? { ...device, active: !device.active } : device)),
        )
    }

    const settingsOptions = [
        { id: "employee-data", title: "Employee Data", icon: <PersonIcon /> },
        { id: "employee-schedule", title: "Employee Schedule", icon: <CalendarMonthIcon /> },
        { id: "users-account", title: "Users Account", icon: <SecurityIcon /> },
        { id: "store-info", title: "Store Info", icon: <StoreIcon /> },
        { id: "notification", title: "Notification", icon: <NotificationsIcon /> },
        { id: "dine-in", title: "Dine In", icon: <RestaurantIcon /> },
        { id: "categories-menu", title: "Categories Menu", icon: <CategoryIcon /> },
        { id: "payment-type", title: "Payment Type", icon: <PaymentIcon /> },
        { id: "bank-account", title: "Bank Account", icon: <AccountBalanceIcon /> },
        { id: "floor-area-data", title: "Floor & Area Data", icon: <LayersIcon /> },
        { id: "printing-device", title: "Printing Device", icon: <PrintIcon /> },
    ]
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.cashier.dineIn && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.cashier.pickUp && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.cashier.delivery && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.cashier.takeaway && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.cashier.reservation && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                    </Grid>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.selfOrder.dineIn && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.selfOrder.pickUp && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.selfOrder.delivery && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.selfOrder.takeaway && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.selfOrder.reservation && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                    </Grid>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.mobileApp.dineIn && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.mobileApp.pickUp && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.mobileApp.delivery && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.mobileApp.takeaway && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                        <Grid item xs={6} sm={4}>
                                            ...
                                            >
                                                ...
                                                >
                                                    {orderTypes.mobileApp.reservation && <CheckIcon sx={{ color: "white", fontSize: 18 }} />}
                                                </Box>
                                            </Card>
                                        </Grid>
                                    </Grid>

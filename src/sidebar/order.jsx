...
import { ReactComponent as FoodIcon } from '../assetts/foodicon.svg';
import { ReactComponent as ShopIcon } from '../assetts/shopping-bag.svg';
import { ReactComponent as SofaIcon } from '../assetts/sofa.svg';
    ...
    <>
      ...
      <div
        ...
        <Box sx={{ 
          ...
          >
            <Box sx={{ px: 2, mb: 2 }}>
              <Typography variant="body2" sx={{ mb: 1, color: '#121212', fontSize: '14px' }}>
                Choose Order Type
              </Typography>
              <ToggleButtonGroup
                value={orderType}
              ...
              >
                ...
                >
                  <FoodIcon sx={{ mb: 0.5, color: orderType === 'dineIn' ? '#063455' : 'inherit' }} />
                ...
                >
                  <ShopIcon sx={{ mb: 0.5, fill: orderType === 'takeaway' ? '#063455' : 'inherit' }} />
                ...
                >
                  <SofaIcon sx={{ mb: 0.5, fill: orderType === 'reservation' ? '#063455' : 'inherit' }} />
